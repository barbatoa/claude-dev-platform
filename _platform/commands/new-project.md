...
---
Create a new prototype named `$ARGUMENTS`. Run from the workspace root.

1. Create `prototypes/$ARGUMENTS/` with `docs/adr/` and run `git init`.
2. Copy `_platform/templates/PROJECT_CLAUDE.md` to `CLAUDE.md`, `_platform/templates/PROJECT_README.md` to `README.md`, and `_platform/templates/FUNCTIONAL_SPEC.md` to `docs/FUNCTIONAL_SPEC.md`; fill in the app name.
